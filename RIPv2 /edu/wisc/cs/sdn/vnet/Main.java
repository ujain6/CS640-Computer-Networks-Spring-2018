...
public class Main 
{
	...
	public static void main(String[] args)
	{
		...
		{
			// Create router instance, also start the two timers associated
			//with ping and garbage collector
		...
		if (dev instanceof Router) 
		{
			...
			{ 
				System.out.println("Calling timers");
				((Router)dev).initialize();
				((Router)dev).timers(); 
				((Router)dev).routeTableGarbage();				
			}
